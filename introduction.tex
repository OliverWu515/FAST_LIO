...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{media/workflow.png}
...
According to the workflow of the FAST-LIO framework~\ref{fig:workflow}, the remainder of this report is organized as follows: 
