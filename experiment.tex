...
the run time whether with the Kalman gain in\eqref{eq:new_kalman_gain} or the efficient form in\eqref{eq:kalman_gain_standard}.
...
\begin{figure}[h]
    ...
    \caption{Processing Time Comparison between Old and New Formulas}
